# React Developer - UOA E-Learning

Exercises from the program **React JS Developer for entry level Job** in modern web development, offered by the [National and Kapodistrian University of Athens (UOA)](https://elearningekpa.gr/) E-Learning program.
...
The program covers 7 modules. The exercises below focus on the React modules:

| #     | Module             | Topics                                     |
|-------|--------------------|--------------------------------------------|
| 1     | UX-UI Design       | UX/UI design principles & practice         |
| 2     | HTML5 & CSS        | Responsive pages, Flexbox, Grid, templates |
| 3     | Bootstrap 5        | Components, layout, practice               |
...
| **7** | **React Practice** | **Full applications**                      |
...
| Exercise            | Description   | Key Concepts |
|---------------------|---------------|--------------|
| 01-basic-apps       | _Coming soon_ |              |
| 02-advanced-app-I   | _Coming soon_ |              |
| 03-advanced-apps-II | _Coming soon_ |              |
